#!/usr/bin/env bash
# ==============================================================================
# LNMP Network Monitoring Platform v3.3.0 - Decommission / Uninstall Utility
# ==============================================================================
...
echo -e "${RED}========================================================================${NC}"
echo -e "${RED}    LNMP Network Monitoring Platform v3.3.0 - Decommission / Uninstall    ${NC}"
echo -e "${RED}========================================================================${NC}"
...
echo -e "\n${GREEN}========================================================================${NC}"
echo -e "${GREEN}   [UNINSTALL COMPLETE] LNMP v3.3.0 platform decommissioned.             ${NC}"
